...
GlobalConfig::$CONNECTION_SETTING->DBName = "gera";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "Cachorro17161324";
...
/** the root url of the application with trailing slash, for example http://localhost/gera/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'gera/';
