/**
 * backbone model definitions for GERA
 */
...
/**
 * Artigo Backbone Model
 */
model.ArtigoModel = Backbone.Model.extend({
	urlRoot: 'api/artigo',
	idAttribute: 'id',
	id: '',
	nome: '',
...
/**
 * Artigo Backbone Collection
 */
model.ArtigoCollection = model.AbstractCollection.extend({
	url: 'api/artigos',
	model: model.ArtigoModel
});
 ...
 * Nota Backbone Model
 */
model.NotaModel = Backbone.Model.extend({
	urlRoot: 'api/nota',
	idAttribute: 'id',
	id: '',
	nota: '',
...
/**
 * Nota Backbone Collection
 */
model.NotaCollection = model.AbstractCollection.extend({
	url: 'api/notas',
	model: model.NotaModel
});
